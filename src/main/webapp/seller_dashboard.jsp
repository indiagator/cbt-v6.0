...
<head>
    ...
    <title>CBT-Seller</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    <link rel="stylesheet" href="styles/styles.css">
    <script type="text/javascript" src="scripts/seller_ds.js"></script>
</head>
        ...
        <div class="row mb-3" >
            ...
            <div class="col-8 themed-grid-col" align="center">
                <div class="central_div" style="width: 100%">
                    ...
                    <section>
                        <form id="create_product_offer" name="create_product_offer" method="post" action="add-product-offer">
